(function($) {
			...
			const slider = new Swiper(sliderEl, {
				...
				on: {
					init: function () {
						...
						document.querySelector(".slider-fraction .total").innerText =
							realSlides;
    ...
    ================================ */
		...
		if (document.querySelectorAll(".service-quick-item").length) {
			const serviceQuickItem = document.querySelectorAll(
				".service-quick-item"
			);
				...
				document
					...
					.forEach((wrap) => {
						...
						items1.forEach((item1) => {
							...
							const item2 = nextCol?.querySelector(
								".design-choose-item-2"
							);
    ...
    ================================ */
		...
		if (document.querySelectorAll(".approach-area").length > 0) {
			...
			mm.add("(min-width: 1199px)", () => {
				...
				const boxesRight = document.querySelectorAll(
				...
				// Left to Right (new)
				const boxesLeft = document.querySelectorAll(
					".approach-area .approach-box2"
				);
